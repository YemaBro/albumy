...
class BaseConfig:
    ALBUMY_ADMIN_EMAIL = os.getenv('ALBUMY_ADMIN', 'yema2358@163.com')
    ...
    MAIL_DEFAULT_SENDER = ('YEMA', os.getenv('MAIL_USERNAME'))
...
class DevelopmentConfig(BaseConfig):
    SQLALCHEMY_DATABASE_URI = 'mysql://root:147896325@localhost:3306/albumy'


class TestingConfig(BaseConfig):
    TESTING = True
    WTF_CSRF_ENABLED = False
    SQLALCHEMY_DATABASE_URI = 'mysql://root:147896325@localhost:3306/albumy_test'
