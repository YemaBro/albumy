...
from flask import Blueprint, render_template, flash, redirect, url_for, current_app, send_from_directory, request, abort
from flask_login import login_required, current_user
from flask_dropzone import random_filename
from sqlalchemy.sql.expression import func

from albumy.decorators import permission_required, confirm_required
from albumy.models import Photo, Tag, Collect, Notification, Follow, User, Comment
...
def read_notification(notification_id):
    ...
    db.session.commit()
    flash('Notification archived.', 'suceess')
