...
from albumy.extensions import db, login_manager, bootstrap, avatars
from albumy.models import Role, User, Photo, Tag, Follow, Comment, Collect, Notification
from albumy.blueprints.admin import admin_bp
from albumy.blueprints.auth import auth_bp
from albumy.blueprints.ajax import ajax_bp
from albumy.blueprints.main import main_bp
from albumy.blueprints.user import user_bp
from albumy.extensions import bootstrap, db, login_manager, avatars, whooshee, mail, moment, csrf, dropzone
...
def register_shell_context(app):
    ...
    def make_shell_context():
        return dict(db=db, User=User, Tag=Tag, Photo=Photo, Follow=Follow,
                    Collect=Collect, Comment=Comment, Notification=Notification)
...
def register_commands(app):
    ...
    def forge(user, follow, photo, tag, collect, comment):
        ...
        from albumy.fakes import fake_admin, fake_comment, fake_follow, fake_photo, fake_tag, fake_user, \
            fake_collect
        db.drop_all()
        db.create_all()
